package com.pbv._writer_reader.utils;
...
public class AskData {
    ...
    public String askString(String msg) {
        ...
        try {
            ...
            while (answer.isEmpty()) {
                System.out.println("You can't leave the answer blank.");
                answer = br.readLine();
            }
    ...
    /**
     * Method to ask a string with length indicated as a parameter
     *
     * @param msg message to show user to ask string
     * @param size size of length of string
     * @return string with length = size
     */
    public String askString(String msg, int size) {
        String answer;
        do {
            answer = askString(msg);
            if (answer.length() != size) {
                System.out.println("Wrong answer. The length must be " + size);
            }
    ...
    public boolean askBoolean(String msg, String errorMsg, String stringTrue, String stringFalse) {
        String answer;
        do {
            answer = askString(msg);
